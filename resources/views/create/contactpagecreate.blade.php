...
<div class="dashboard-container">
    ...
    <div class="content">
        ...
        <form method="POST" action="{{ route('contact.store') }}">
            ...
            <div class="form-group">
                <label for="ContactTitleAddress">Sub Title</label>
                <input type="text" class="form-control" name=" ContactTitleAddress">
            </div>

            <div class="form-group">
                <label for="ContactTitleNumber">Sub Title</label>
                <input type="text" class="form-control" name=" ContactTitleNumber">
            </div>

            <div class="form-group">
                <label for="ContactTitleNumber2">Sub Title</label>
                <input type="text" class="form-control" name=" ContactTitleNumber2">
            </div>

            <div class="form-group">
                <label for="ContactTitleEmail">Sub Title</label>
