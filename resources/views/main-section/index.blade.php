      ...
      <div class="col-12 py-md-5 who-we-what-bx">
        <div class="row">
          <div class="col-12 col-md-11 mx-auto py-3">
            ...
            <style>
    /* Define the custom CSS styles here */
    .custom-margin {
        ...
        margin-bottom: calc(var(--bs-gutter-x) * -.5);
            ...
            @foreach($banners as $banner)
    @php
        $subtitles = explode(',', $banner->SubTitle);
        $subdescriptions = explode(',', $banner->SubTitleDes);
    @endphp
          ...
          <!-- <div class="row">
            <div class="col-11 mx-auto"> -->
              ...
              <ul class="nav nav-pills nav-justified tab-bg custom-tab-pills" id="myTab" role="tablist">
                ...
                @php
                 $servicetitles = explode(',', $banner->ServiceTitle);
                @endphp

               @for ($i = 0; $i < count($servicetitles); $i++)
               <li class="nav-item" role="presentation">
                  <button class="nav-link py-md-4" id="vCISO-services" data-bs-toggle="tab" data-bs-target="#a"
                    type="button" role="tab" aria-controls="contact" aria-selected="false">{{$servicetitles[$i]}}<span
                      class="nav-item-arrow"></span></button>
                </li>
               @endfor
              </ul>
              ...
              <div class="tab-content" id="myTabContent">
                ...
                @php
                $servicetitle = explode(',', $banner->ServiceTitle);
                 $servicedescriptions = explode(',', $banner->ServiceDes);
                @endphp
                @for ($i = 0; $i < count($servicetitle);$i++ )
                <div class="tab-pane fade" id="a" role="tabpanel" aria-labelledby="vCISO-services">
                  <div class="row">
                    <div class="col-12 col-md-11 mx-auto pt-4">
                      <div class="row">
                        <div class="col-12 col-md-6 order-2 order-md-1">
                          <h2 class="pb-3">{{$servicetitle[$i]}}</h2>
                        
                          <p>{{$servicedescriptions[$i]}}<br /><a class="learn-more" href="vCiso-service.html">Learn more <span
                                class="bounce">>></span></a></p>
                        </div>
                        <div class="col-12 pb-3 pb-md-4 col-md-6 order-1 order-md-2 text-end">
                          <img src="images/it_managed_services.png" class="w-100 w-md-auto" alt="">
